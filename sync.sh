...
# Sync orchestrator skills (13 total)
log "Syncing orchestrator skills..."
for skill in workflow-runner smart-commit deep-review debug-flow project-context agent-guide scaffold impact-check gen-tests refactor migrate doc-gen dep-audit; do
...
cp "$CLAUDE_DIR"/commands/code-review.md "$CLAUDE_DIR"/commands/creative-writer.md "$CLAUDE_DIR"/commands/data-analyst.md "$CLAUDE_DIR"/commands/project-manager.md "$CLAUDE_DIR"/commands/research-assistant.md "$CLAUDE_DIR"/commands/system-architect.md "$CLAUDE_DIR"/commands/test-gen.md "$CLAUDE_DIR"/commands/explain.md "$CLAUDE_DIR"/commands/security-scan.md "$CLAUDE_DIR"/commands/perf-audit.md "$SCRIPT_DIR/commands/general/" 2>/dev/null || true
