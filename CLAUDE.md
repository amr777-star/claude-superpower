...
- Financial models (DCF, 3-statement, SaaS, cap table) → `/financial-modeler`
- Pitch decks & presentations (Sequoia, YC, Kawasaki) → `/pitch-deck`
- Strategic analysis (SWOT, Porter's, PESTEL, BCG, Blue Ocean) → `/strategy-analyst`
- Fundraising (SAFE, term sheets, cap tables, due diligence) → `/fundraising-advisor`
